...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	// 【注目】上方向を設定。今回はライトが真下を向ているのでX方向を上にしている
	lightCamera.SetUp(1, 0, 0);

	// 今回のサンプルでは画角をせまめにしておく
	lightCamera.SetViewAngle(Math::DegToRad(20.f));
	...
	while (DispatchWindowMessage())
	{
		...
		//sprite.Update({ FRAME_BUFFER_W / -2.0f, FRAME_BUFFER_H / 2.0f,  0.0f }, g_quatIdentity, g_vec3One, { 0.0f, 0.5f });
