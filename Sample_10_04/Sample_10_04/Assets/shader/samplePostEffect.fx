...
float4 PSBlur(PS_BlurInput In) : SV_Target0
{
	...
	// 基準テクセルからプラス方向に８テクセル、重み付きでサンプリング
	...
	// 基準テクセルからマイナス方向に８テクセル、重み付きでサンプリング
